 ...
 * 
 */
@WebServiceClient(name = "ServiceImplService", targetNamespace = "http://cn.com/", wsdlLocation = "http://localhost:8089/webservice/ws?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVICEIMPLSERVICE_QNAME = new QName("http://cn.com/", "ServiceImplService");
    ...
    public ServiceImpl getServiceImplPort() {
        return super.getPort(new QName("http://cn.com/", "ServiceImplPort"), ServiceImpl.class);
    }
    ...
    public ServiceImpl getServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://cn.com/", "ServiceImplPort"), ServiceImpl.class, features);
    }
